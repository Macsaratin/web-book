                      ...
                      <td>
                        <div class="input-group quantity mt-4" style="width: 100px;">
                          <div class="input-group-btn">
                            <button class="btn btn-sm btn-minus rounded-circle bg-light border" @click="changeQuantity(item, 'decrease')">
                              <i class="fa fa-minus"></i>
                            </button>
                          </div>
                          <input type="text" class="form-control form-control-sm text-center border-0" v-model="item.quantity" @input="updateTotal(item)" readonly />
                          <div class="input-group-btn">
                            <button class="btn btn-sm btn-plus rounded-circle bg-light border" @click="changeQuantity(item, 'increase')">
...
const updateTotal = (item) => {
  ...
  item.totalPrice = item.quantity * discountedPrice;  // Update total price after discount
};

// Compute the total payment for all items
